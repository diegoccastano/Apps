...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Travel",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC6Travel11AppDelegate")
...
SWIFT_CLASS("_TtC6Travel13SceneDelegate")
...
SWIFT_CLASS("_TtC6Travel13TableViewCell")
@interface TableViewCell : UITableViewCell
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified labelTitle;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified labelDays;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified labelValue;
...
SWIFT_CLASS("_TtC6Travel9TravelDAO")
@interface TravelDAO : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC6Travel14ViewController")
@interface ViewController : UIViewController <UITableViewDataSource, UITableViewDelegate>
@property (nonatomic, weak) IBOutlet UITableView * _Null_unspecified tableViewTravel;
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified viewButtonHotels;
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified viewButtonPackages;
- (void)viewDidLoad;
