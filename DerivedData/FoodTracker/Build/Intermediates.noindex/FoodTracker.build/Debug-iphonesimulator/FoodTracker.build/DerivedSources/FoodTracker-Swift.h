...
SWIFT_CLASS("_TtC11FoodTracker22AddItemsViewController")
...
SWIFT_CLASS("_TtC11FoodTracker4Item")
...
SWIFT_CLASS("_TtC11FoodTracker24MealsTableViewController")
...
- (void)showDetails:(UILongPressGestureRecognizer * _Nonnull)gesture;
...
@property (nonatomic, weak) IBOutlet UITableView * _Nullable itemsTableView;
@property (nonatomic, strong) IBOutlet UITextField * _Nullable nameTextField;
@property (nonatomic, strong) IBOutlet UITextField * _Nullable happinessTextField;
- (void)viewDidLoad;
- (void)addItem;
